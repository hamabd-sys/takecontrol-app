...
const SURAHS = [
  ...
  {n:2,  en:"Al-Baqarah",     ar:"البقرة",      alt:["baqara","baqarah","cow"]},
  {n:3,  en:"Aali Imran",     ar:"آل عمران",    alt:["ali imran","imran","family of imran"]},
  {n:4,  en:"An-Nisa",        ar:"النساء",      alt:["nisa","nisa'","women"]},
  {n:5,  en:"Al-Ma'idah",     ar:"المائدة",     alt:["maidah","ma'ida","table","table spread"]},
  {n:6,  en:"Al-An'am",       ar:"الأنعام",     alt:["anam","an'am","cattle","livestock"]},
  {n:7,  en:"Al-A'raf",       ar:"الأعراف",     alt:["araf","a'raf","heights","elevated places"]},
  {n:8,  en:"Al-Anfal",       ar:"الأنفال",     alt:["anfal","spoils of war","booty"]},
  ...
  {n:20, en:"Ta-Ha",          ar:"طه",          alt:["taha","ta-ha","ta ha"]},
  {n:21, en:"Al-Anbiya",      ar:"الأنبياء",    alt:["anbiya","prophets"]},
  {n:22, en:"Al-Hajj",        ar:"الحج",        alt:["hajj","pilgrimage"]},
  {n:23, en:"Al-Mu'minun",    ar:"المؤمنون",    alt:["muminun","mu'minun","believers"]},
  {n:24, en:"An-Nur",         ar:"النور",       alt:["nur","light"]},
  {n:25, en:"Al-Furqan",      ar:"الفرقان",     alt:["furqan","criterion"]},
  {n:26, en:"Ash-Shu'ara",    ar:"الشعراء",     alt:["shuara","shu'ara","poets"]},
  {n:27, en:"An-Naml",        ar:"النمل",       alt:["naml","ants"]},
  {n:28, en:"Al-Qasas",       ar:"القصص",       alt:["qasas","stories","narrative"]},
  {n:29, en:"Al-Ankabut",     ar:"العنكبوت",    alt:["ankabut","spider"]},
  {n:30, en:"Ar-Rum",         ar:"الروم",       alt:["rum","romans","byzantines"]},
  {n:31, en:"Luqman",         ar:"لقمان",       alt:["luqman","luqmaan"]},
  {n:32, en:"As-Sajdah",      ar:"السجدة",      alt:["sajdah","sajda","prostration"]},
  {n:33, en:"Al-Ahzab",       ar:"الأحزاب",     alt:["ahzab","confederates","clans"]},
  {n:34, en:"Saba",           ar:"سبإ",         alt:["saba","sheba"]},
  {n:35, en:"Fatir",          ar:"فاطر",        alt:["fatir","originator","creator"]},
  {n:36, en:"Ya-Sin",         ar:"يس",          alt:["yasin","ya sin","ya-sin"]},
  {n:37, en:"As-Saffat",      ar:"الصافات",     alt:["saffat","saffaat","those who set the ranks"]},
  {n:38, en:"Sad",            ar:"ص",           alt:["sad","saad"]},
  {n:39, en:"Az-Zumar",       ar:"الزمر",       alt:["zumar","groups","crowds"]},
  {n:40, en:"Ghafir",         ar:"غافر",        alt:["ghafir","forgiving","mu'min"]},
  {n:41, en:"Fussilat",       ar:"فصلت",        alt:["fussilat","explained in detail","ha-mim"]},
  {n:42, en:"Ash-Shura",      ar:"الشورى",      alt:["shura","consultation"]},
  {n:43, en:"Az-Zukhruf",     ar:"الزخرف",      alt:["zukhruf","gold adornments","ornaments"]},
  {n:44, en:"Ad-Dukhan",      ar:"الدخان",      alt:["dukhan","smoke"]},
  {n:45, en:"Al-Jathiyah",    ar:"الجاثية",     alt:["jathiyah","crouching","kneeling"]},
  {n:46, en:"Al-Ahqaf",       ar:"الأحقاف",     alt:["ahqaf","wind-curved sandhills"]},
  {n:47, en:"Muhammad",       ar:"محمد",        alt:["muhammad","mohammed"]},
  {n:48, en:"Al-Fath",        ar:"الفتح",       alt:["fath","victory"]},
  {n:49, en:"Al-Hujurat",     ar:"الحجرات",     alt:["hujurat","hujuraat","chambers","private apartments"]},
  {n:50, en:"Qaf",            ar:"ق",           alt:["qaf"]},
  {n:51, en:"Adh-Dhariyat",   ar:"الذاريات",    alt:["dhariyat","dhaariyaat","scattering winds"]},
  {n:52, en:"At-Tur",         ar:"الطور",       alt:["tur","mount","the mount"]},
  {n:53, en:"An-Najm",        ar:"النجم",       alt:["najm","star"]},
  {n:54, en:"Al-Qamar",       ar:"القمر",       alt:["qamar","moon"]},
  {n:55, en:"Ar-Rahman",      ar:"الرحمن",      alt:["rahman","most gracious","most merciful"]},
  {n:56, en:"Al-Waqi'ah",     ar:"الواقعة",     alt:["waqiah","waqia","inevitable","event"]},
  {n:57, en:"Al-Hadid",       ar:"الحديد",      alt:["hadid","iron"]},
  {n:58, en:"Al-Mujadila",    ar:"المجادلة",    alt:["mujadila","mujadilah","pleading woman","dispute"]},
  {n:59, en:"Al-Hashr",       ar:"الحشر",       alt:["hashr","exile","gathering"]},
  {n:60, en:"Al-Mumtahanah",  ar:"الممتحنة",    alt:["mumtahanah","she that is to be examined","testing"]},
  {n:61, en:"As-Saf",         ar:"الصف",        alt:["saf","saff","ranks","battle array"]},
  {n:62, en:"Al-Jumu'ah",     ar:"الجمعة",      alt:["jumu'ah","jumua","juma","friday","congregation"]},
  {n:63, en:"Al-Munafiqun",   ar:"المنافقون",   alt:["munafiqun","hypocrites"]},
  {n:64, en:"At-Taghabun",    ar:"التغابن",     alt:["taghabun","mutual disillusion","loss and gain"]},
  {n:65, en:"At-Talaq",       ar:"الطلاق",      alt:["talaq","divorce"]},
  {n:66, en:"At-Tahrim",      ar:"التحريم",     alt:["tahrim","tahrem","banning","prohibition"]},
  {n:67, en:"Al-Mulk",        ar:"الملك",       alt:["mulk","sovereignty","dominion"]},
  {n:68, en:"Al-Qalam",       ar:"القلم",       alt:["qalam","pen"]},
  {n:69, en:"Al-Haqqah",      ar:"الحاقة",      alt:["haqqah","haaqqa","inevitable","reality"]},
  {n:70, en:"Al-Ma'arij",     ar:"المعارج",     alt:["ma'arij","maarij","ascending stairways","ways of ascent"]},
  {n:71, en:"Nuh",            ar:"نوح",         alt:["nuh","noah"]},
  {n:72, en:"Al-Jinn",        ar:"الجن",        alt:["jinn","jinn"]},
  {n:73, en:"Al-Muzzammil",   ar:"المزمل",      alt:["muzzammil","enshrouded","wrapped in garments"]},
  {n:74, en:"Al-Muddaththir", ar:"المدثر",      alt:["muddaththir","muddassir","wrapped","covered"]},
  {n:75, en:"Al-Qiyamah",     ar:"القيامة",     alt:["qiyamah","qiyama","resurrection"]},
  {n:76, en:"Al-Insan",       ar:"الإنسان",     alt:["insan","human","man","dahr","time"]},
  {n:77, en:"Al-Mursalat",    ar:"المرسلات",    alt:["mursalat","emissaries","winds sent forth"]},
  {n:78, en:"An-Naba",        ar:"النبإ",       alt:["naba","tidings","great news"]},
  {n:79, en:"An-Nazi'at",     ar:"النازعات",    alt:["nazi'at","naziat","those who drag forth","soul-snatchers"]},
  {n:80, en:"Abasa",          ar:"عبس",         alt:["abasa","he frowned","frowned"]},
  {n:81, en:"At-Takwir",      ar:"التكوير",     alt:["takwir","folding up","overthrowing"]},
  {n:82, en:"Al-Infitar",     ar:"الانفطار",    alt:["infitar","cleaving","bursting apart"]},
  {n:83, en:"Al-Mutaffifin",  ar:"المطففين",    alt:["mutaffifin","defrauding","those who give short measure"]},
  {n:84, en:"Al-Inshiqaq",    ar:"الانشقاق",    alt:["inshiqaq","splitting open","rending asunder"]},
  {n:85, en:"Al-Buruj",       ar:"البروج",      alt:["buruj","mansions of the stars","constellations"]},
  {n:86, en:"At-Tariq",       ar:"الطارق",      alt:["tariq","night-comer","morning star"]},
  {n:87, en:"Al-A'la",        ar:"الأعلى",      alt:["ala","a'la","the most high","glorify"]},
  {n:88, en:"Al-Ghashiyah",   ar:"الغاشية",     alt:["ghashiyah","overwhelming","pall"]},
  {n:89, en:"Al-Fajr",        ar:"الفجر",       alt:["fajr","dawn","daybreak"]},
  {n:90, en:"Al-Balad",       ar:"البلد",       alt:["balad","city","town"]},
  {n:91, en:"Ash-Shams",      ar:"الشمس",       alt:["shams","sun"]},
  {n:92, en:"Al-Layl",        ar:"الليل",       alt:["layl","night"]},
  {n:93, en:"Ad-Duha",        ar:"الضحى",       alt:["duha","morning hours","forenoon"]},
  {n:94, en:"Ash-Sharh",      ar:"الشرح",       alt:["sharh","relief","opening up","inshirah"]},
  {n:95, en:"At-Tin",         ar:"التين",       alt:["tin","fig","the fig"]},
  {n:96, en:"Al-Alaq",        ar:"العلق",       alt:["alaq","clot","read","iqra"]},
  {n:97, en:"Al-Qadr",        ar:"القدر",       alt:["qadr","night of decree","power"]},
  {n:98, en:"Al-Bayyinah",    ar:"البينة",      alt:["bayyinah","clear evidence","proof"]},
  {n:99, en:"Az-Zalzalah",    ar:"الزلزلة",     alt:["zalzalah","earthquake"]},
  {n:100,en:"Al-Adiyat",      ar:"العاديات",    alt:["adiyat","the chargers","war horses"]},
  {n:101,en:"Al-Qari'ah",     ar:"القارعة",     alt:["qari'ah","qariah","calamity","striking hour"]},
  {n:102,en:"At-Takathur",    ar:"التكاثر",     alt:["takathur","competition","rivalry"]},
  {n:103,en:"Al-Asr",         ar:"العصر",       alt:["asr","declining day","time","afternoon"]},
  {n:104,en:"Al-Humazah",     ar:"الهمزة",      alt:["humazah","slanderer","gossip-monger"]},
  {n:105,en:"Al-Fil",         ar:"الفيل",       alt:["fil","elephant"]},
  {n:106,en:"Quraysh",        ar:"قريش",        alt:["quraysh","quraish","koreich"]},
  {n:107,en:"Al-Ma'un",       ar:"الماعون",     alt:["ma'un","maun","small kindnesses","almsgiving"]},
  {n:108,en:"Al-Kawthar",     ar:"الكوثر",      alt:["kawthar","abundance","river in paradise"]},
  {n:109,en:"Al-Kafirun",     ar:"الكافرون",    alt:["kafirun","disbelievers","kafiroon"]},
  {n:110,en:"An-Nasr",        ar:"النصر",       alt:["nasr","divine support","victory","help"]},
  {n:111,en:"Al-Masad",       ar:"المسد",       alt:["masad","palm fiber","lahab","abu lahab"]},
  {n:112,en:"Al-Ikhlas",      ar:"الإخلاص",     alt:["ikhlas","sincerity","purity"]},
  {n:113,en:"Al-Falaq",       ar:"الفلق",       alt:["falaq","daybreak","dawn"]},
...
const searchSurahs = (q) => {
  ...
  return SURAHS.filter(s => {
    const enClean = s.en.toLowerCase().replace(/['-]/g,"");
    const arClean = s.ar;
    const altMatch = s.alt.some(a => a.replace(/['-]/g,"").includes(lower));
    return enClean.includes(lower) || arClean.includes(q) || altMatch;
  }).slice(0, 6);
};
...
function StoreProvider({ children }) {
  const [state, dispatch] = useReducer(reducer, null, () => {
    try {
      const raw = localStorage.getItem("tc_v5");
  ...
  useEffect(() => { try { localStorage.setItem("tc_v5", JSON.stringify(state)); } catch {} }, [state]);
...
function Card({ children, style = {}, cls = "", onClick }) {
  return (
    <div className={cls} onClick={onClick}
      style={{ background:"var(--bg2)", border:"1px solid var(--border)", borderRadius:"16px", padding:"22px", ...style }}>
      {children}
    </div>
  );
}

// "Label" = section heading inside a card — now clearly visible
function Label({ children }) {
  return (
    <div style={{
      fontFamily:"var(--font-m)", fontSize:"11px", color:"var(--text2)",
...
function Btn({ children, onClick, variant="primary", style={}, disabled=false }) {
  return (
    <button onClick={onClick} disabled={disabled}
      style={{ padding:"12px 20px", borderRadius:"10px", fontFamily:"var(--font-ui)", fontSize:"13px", fontWeight:700, letterSpacing:"0.09em", textTransform:"uppercase", cursor:disabled?"default":"pointer", opacity:disabled?.4:1, ...BTN_V[variant], ...style }}>
      {children}
    </button>
  );
}
...
function Tag({ children, done }) {
  return (
    <span style={{ display:"inline-flex", alignItems:"center", gap:"5px", padding:"3px 9px", borderRadius:"5px", fontFamily:"var(--font-m)", fontSize:"10px", background:done?"rgba(0,229,176,.07)":"rgba(255,255,255,.03)", color:done?"var(--accent)":"var(--text3)", border:`1px solid ${done?"rgba(0,229,176,.18)":"var(--border)"}` }}>
      {done?"✓":"·"} {children}
    </span>
  );
}
...
function IconBtn({ children, onClick, disabled, danger, title }) {
  return (
    <button title={title} onClick={onClick} disabled={disabled}
      style={{ width:"26px", height:"26px", borderRadius:"6px", flexShrink:0, background:danger?"rgba(230,64,64,.07)":"var(--bg4)", border:`1px solid ${danger?"rgba(230,64,64,.18)":"var(--border)"}`, color:danger?"#f87171":"var(--text2)", cursor:disabled?"default":"pointer", opacity:disabled?.25:1, fontSize:"11px", display:"flex", alignItems:"center", justifyContent:"center" }}>
      {children}
    </button>
  );
}

// Shared subtitle used under big page titles
function PageSub({ children }) {
  return (
    <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.18em", marginTop:"5px" }}>
      {children}
    </div>
  );
}
  ...
  return (
    <div>
      <div style={{ display:"flex", alignItems:"center", gap:"12px", marginBottom:"13px" }}>
        ...
        <span style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:done?"var(--accent)":"var(--text3)", whiteSpace:"nowrap" }}>
          {checked}/{tasks.length}{done?" ✓":""}
        </span>
      </div>
      {done && (
        <div style={{ display:"flex", alignItems:"center", gap:"10px", padding:"11px 14px", borderRadius:"10px", background:"rgba(0,229,176,.05)", border:"1px solid rgba(0,229,176,.14)", marginBottom:"13px" }}>
          ...
          <div>
            ...
            <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"2px" }}>All tasks done — points applied.</div>
          </div>
        </div>
      )}
      <div style={{ display:"grid", gap:"6px" }}>
          ...
          <div key={task.id} style={{ display:"flex", alignItems:"center", gap:"9px", padding:"10px 11px", borderRadius:"10px", background:task.checked?"rgba(0,229,176,.04)":"var(--bg3)", border:`1px solid ${task.checked?"rgba(0,229,176,.12)":"var(--border)"}`, transition:"all .18s" }}>
            ...
            {editId===task.id ? (
              ...
              <span onDoubleClick={() => startEdit(task)} title="Double-click to rename"
                style={{ flex:1, fontFamily:"var(--font-ui)", fontSize:"14px", fontWeight:500, color:task.checked?"var(--text2)":"var(--text)", textDecoration:task.checked?"line-through":"none", cursor:"text", userSelect:"none" }}>
                {task.label}
              </span>
            )}
        ...
        {tasks.length===0 && (
          <div style={{ textAlign:"center", padding:"22px", fontFamily:"var(--font-m)", fontSize:"11px", color:"var(--text3)" }}>No tasks — add one below.</div>
        )}
      </div>
...
function SurahInput({ value, onChange }) {
  ...
  const select = (s) => {
    const label = `${s.en} (${s.ar})`;
    setQuery(label); onChange(label); setOpen(false);
  };

  const handleChange = (e) => {
    setQuery(e.target.value); onChange(e.target.value);
  ...
  return (
    <div ref={ref} style={{ position:"relative" }}>
      <input
        type="text"
        placeholder="e.g. Baqarah, Kahf, Rahman…"
        value={query}
      ...
      {open && results.length > 0 && (
        <div style={{ position:"absolute", top:"calc(100% + 4px)", left:0, right:0, zIndex:20, background:"var(--bg1)", border:"1px solid var(--border2)", borderRadius:"10px", overflow:"hidden", boxShadow:"0 8px 32px rgba(0,0,0,.6)" }}>
          {results.map(s => (
            <button key={s.n} onMouseDown={() => select(s)}
              ...
              <div>
                <span style={{ fontFamily:"var(--font-m)", fontSize:"9px", color:"var(--text3)", marginRight:"8px" }}>{String(s.n).padStart(3,"0")}</span>
...
function WeightChart({ history, period }) {
  ...
  if (data.length === 0) return (
    <div style={{ textAlign:"center", padding:"48px 0", fontFamily:"var(--font-m)", fontSize:"11px", color:"var(--text3)" }}>
      No weight data for this period.<br/><span style={{ fontSize:"9px",opacity:.6 }}>Log daily to see trends.</span>
    </div>
  );
  ...
  const areaPath=data.length>=2?`${linePath} L${xPos(data.length-1).toFixed(1)},${(PT+cH).toFixed(1)} L${xPos(0).toFixed(1)},${(PT+cH).toFixed(1)}Z`:"";

  const fmtDate=(s)=>{const d=new Date(s+"T12:00:00");return `${d.getDate()}/${d.getMonth()+1}`;};
    ...
    <div>
      <svg viewBox={`0 0 ${W} ${H}`} style={{ width:"100%", height:"auto", display:"block" }}>
        ...
        {[minV,(minV+maxV)/2,maxV].map((v,i)=>(
          <text key={i} x={PL-6} y={yPos(v)+4} fill="#686868" fontSize="9" fontFamily="monospace" textAnchor="end">{Math.round(v*10)/10}</text>
        ))}
        {xIdx.map(idx=>(
          <text key={idx} x={xPos(idx)} y={H-5} fill="#686868" fontSize="9" fontFamily="monospace" textAnchor="middle">{fmtDate(data[idx].date)}</text>
        ))}
      </svg>
...
function Onboarding({ onComplete }) {
  ...
  return (
    <div style={{ position:"fixed", inset:0, background:"#080808", display:"flex", alignItems:"center", justifyContent:"center", padding:"40px", overflow:"hidden" }}>
      <div style={{ position:"absolute", inset:0, opacity:.022, backgroundImage:"repeating-linear-gradient(0deg,transparent,transparent 40px,#00e5b0 40px,#00e5b0 41px),repeating-linear-gradient(90deg,transparent,transparent 40px,#00e5b0 40px,#00e5b0 41px)" }}/>
      <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", width:"600px", height:"600px", borderRadius:"50%", background:"radial-gradient(circle,rgba(0,229,176,.05) 0%,transparent 70%)", pointerEvents:"none" }}/>
      <div style={{ maxWidth:"500px", width:"100%", zIndex:1 }}>
        ...
        <div className="ob-sub" style={{ fontFamily:"var(--font-m)", fontSize:"11px", color:"var(--text3)", letterSpacing:"0.15em", marginBottom:"28px", lineHeight:1.7 }}>
          ...
          GIVE IT A NAME TO ADDRESS YOU BY.
        </div>
        <div className={`ob-inp${shaking?" shake":""}`} style={{ marginBottom:"12px" }}>
          <input ref={ref} type="text" value={name} onChange={e=>setName(e.target.value)}
            onKeyDown={e=>e.key==="Enter"&&submit()} placeholder="Your name" maxLength={30}
            style={{ width:"100%", background:"rgba(255,255,255,.04)", border:`1px solid ${shaking?"rgba(230,64,64,.5)":"var(--border2)"}`, borderRadius:"12px", padding:"18px 20px", color:"var(--text)", fontFamily:"var(--font-d)", fontSize:"36px", outline:"none", letterSpacing:"0.1em", transition:"border-color .2s" }}/>
        ...
        <div className="ob-btn">
          <button onClick={submit} style={{ width:"100%", padding:"18px", background:"var(--accent)", border:"none", borderRadius:"12px", color:"#000", fontFamily:"var(--font-d)", fontSize:"28px", letterSpacing:"0.18em", cursor:"pointer" }}>
            PROCEED →
          </button>
        </div>
      </div>
  ...
  return (
    <div className="modal-bg" style={{ position:"fixed", inset:0, zIndex:100, background:"rgba(0,0,0,.78)", backdropFilter:"blur(5px)", display:"flex", alignItems:"center", justifyContent:"center", padding:"20px" }}>
      <div className="modal-card" style={{ background:"var(--bg2)", border:"1px solid var(--border2)", borderRadius:"20px", padding:"32px", maxWidth:"360px", width:"100%" }}>
        <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.22em", marginBottom:"8px" }}>DAILY CHECK-IN</div>
        ...
        <div style={{ display:"flex", gap:"8px", marginBottom:"13px" }}>
          {["kg","lbs"].map(u=>(
            <button key={u} onClick={()=>setUnit(u)} style={{ flex:1, padding:"8px", borderRadius:"8px", background:unit===u?"rgba(0,229,176,.1)":"var(--bg3)", border:`1px solid ${unit===u?"rgba(0,229,176,.3)":"var(--border)"}`, color:unit===u?"var(--accent)":"var(--text2)", fontFamily:"var(--font-m)", fontSize:"11px", cursor:"pointer" }}>{u}</button>
          ))}
        </div>
...
function Sidebar({ page, navigate, open, setOpen }) {
  ...
  // ── ORDER: Dashboard → Wake → Training → Prayers → Quran → Control → Sleep
  const routes = [
    ...
    <>
      ...
      <aside style={{ position:"fixed", top:0, left:0, bottom:0, width:"220px", zIndex:50, background:"var(--bg1)", borderRight:"1px solid var(--border)", display:"flex", flexDirection:"column", transform:open?"translateX(0)":"translateX(-100%)", transition:"transform .28s cubic-bezier(.4,0,.2,1)" }}>
        ...
        <div style={{ padding:"24px 18px 18px", borderBottom:"1px solid var(--border)" }}>
          ...
          {/* ── These were the "too dim" subtexts — now use --text3 which is #686868 ── */}
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"3px", letterSpacing:"0.15em" }}>BEHAVIORAL OS v5.0</div>
          {state.profile.name && (
        ...
        <div style={{ padding:"14px 18px", borderBottom:"1px solid var(--border)" }}>
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.15em", marginBottom:"5px" }}>CONTROL INDEX</div>
        ...
        <div style={{ padding:"14px 18px", borderTop:"1px solid var(--border)" }}>
          {/* Footer subtexts — bumped to text3 (#686868) */}
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)" }}>{getTodayDate()}</div>
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"2px" }}>STREAK: {state.control.streak}d</div>
        </div>
      </aside>
    </>
  );
    ...
    <>
      ...
      <div style={{ display:"grid", gap:"18px" }}>
        ...
        <Card cls="fu" style={{ position:"relative", overflow:"hidden" }}>
          ...
          {/* "CONTROL INDEX — name — date" subtitle: use text2 for good contrast */}
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text2)", letterSpacing:"0.18em", marginBottom:"4px" }}>
        ...
        <div className="fu1" style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))", gap:"13px" }}>
          ...
          <Card cls="fu1" style={{ cursor:"pointer", borderColor:weightToday?"rgba(0,229,176,.2)":"var(--border)" }} onClick={()=>navigate("weight")}>
        ...
        <Card cls="fu3" style={{ cursor:"pointer" }} onClick={()=>navigate("prayers")}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
            <div>
              <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.15em", marginBottom:"5px" }}>
            ...
            <div style={{ display:"flex", gap:"6px", alignItems:"center" }}>
              {PRAYERS_DATA.map(p => {
                const d = !!(dayLog[p.key]?.fard);
                return <div key={p.key} style={{ width:"10px", height:"10px", borderRadius:"50%", background:d?p.color:"var(--bg4)", border:`1px solid ${d?p.color:"var(--border2)"}`, transition:"all .2s" }}/>;
              })}
  ...
  return (
    <div style={{ display:"grid", gap:"18px", maxWidth:"620px" }}>
      <Card cls="fu">
        ...
        {/* Subtitle now uses --text2 (a0a0a0) not --text3 */}
        ...
        {done ? (
          <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"3px" }}>Already logged today. +30 pts applied.</div>
            </div>
          </div>
        ) : (
        ...
        {hoursLogged ? (
          <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"3px" }}>Already logged. Sleep well.</div>
            </div>
          </div>
        ) : (
      ...
      <Card cls="fu" style={{ position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
          <div>
            ...
            <div style={{ fontFamily:"var(--font-d)", fontSize:"52px", lineHeight:1, color:allDone?"var(--accent)":"var(--text)", marginTop:"6px" }}>
        ...
        {friday && (
          <div style={{ marginTop:"13px", padding:"10px 13px", borderRadius:"9px", background:"rgba(255,209,102,.05)", border:"1px solid rgba(255,209,102,.14)" }}>
            ...
            <div style={{ fontFamily:"var(--font-ui)", fontSize:"12px", color:"var(--text2)" }}>Friday — Dhuhr is replaced with Jumu'ah prayer.</div>
          </div>
        )}
      </Card>
      ...
      {PRAYERS_DATA.map((prayer, pidx) => {
        ...
        return (
          <Card key={prayer.key} cls={`fu${Math.min(pidx+1,5)}`}
            style={{ borderLeft:`3px solid ${allChk?prayer.color:prayer.color+"33"}`, transition:"border-color .3s" }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"13px" }}>
              <div>
                ...
                <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.1em", marginTop:"2px" }}>{time}</div>
              </div>
              ...
              {rows.map((row, ridx) => {
                ...
                return (
                  <button key={ridx}
                    ...
                    style={{ display:"flex", alignItems:"center", gap:"12px", padding:"11px 13px", borderRadius:"9px", cursor:"pointer", textAlign:"left", background:checked?`${prayer.color}14`:"var(--bg3)", border:`1px solid ${checked?prayer.color+"35":"var(--border)"}`, transition:"all .18s" }}>
                    ...
                    <span style={{ fontFamily:"var(--font-m)", fontSize:"9px", flexShrink:0, padding:"3px 8px", borderRadius:"4px", color:isFard?prayer.color:"var(--text3)", background:isFard?`${prayer.color}12`:"transparent", border:isFard?`1px solid ${prayer.color}25`:"none" }}>
                      {row.rak}
                    </span>
                  </button>
                );
...
function Quran() {
  ...
  return (
    <div style={{ display:"grid", gap:"18px", maxWidth:"600px" }}>
      ...
      <Card cls="fu2">
        <Label>Current Khatmah — {QURAN_PAGES} Pages</Label>
        <div style={{ display:"flex", alignItems:"center", gap:"16px", marginBottom:"14px" }}>
          ...
          <div>
            ...
            {khatmahs>0 && <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--warn)", marginTop:"3px" }}>✓ {khatmahs} khatmah{khatmahs>1?"s":""} complete</div>}
          </div>
        </div>
      ...
      <Card cls="fu3">
        ...
        <div style={{ marginBottom:"12px" }}>
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text2)", letterSpacing:"0.15em", marginBottom:"6px" }}>PAGES READ *</div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"10px", marginBottom:"14px" }}>
          <div>
            <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text2)", letterSpacing:"0.15em", marginBottom:"6px" }}>FROM PAGE (optional)</div>
            <input type="number" min="1" max="604" placeholder="e.g. 218" value={fromPage} onChange={e=>setFromPage(e.target.value)}
              style={{ width:"100%", background:"var(--bg3)", border:"1px solid var(--border)", borderRadius:"8px", padding:"9px 12px", color:"var(--text)", fontFamily:"var(--font-ui)", fontSize:"15px", outline:"none" }}/>
          </div>
          <div>
            <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text2)", letterSpacing:"0.15em", marginBottom:"6px" }}>SURAH (optional)</div>
            {/* Surah autocomplete */}
  ...
  return (
    <div style={{ display:"grid", gap:"18px", maxWidth:"640px" }}>
      ...
      {state.weight.current && (
        <Card cls="fu">
          <div style={{ display:"flex", gap:"28px", alignItems:"baseline", flexWrap:"wrap" }}>
            <div>
              <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.15em", marginBottom:"3px" }}>CURRENT</div>
            ...
            <div>
              <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.15em", marginBottom:"3px" }}>TOTAL LOGS</div>
              <div style={{ fontFamily:"var(--font-d)", fontSize:"40px", color:"var(--text2)", lineHeight:1 }}>{state.weight.history.length}</div>
            </div>
            <div>
              <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", letterSpacing:"0.15em", marginBottom:"3px" }}>FIRST LOGGED</div>
      ...
      <div className="fu1" style={{ display:"flex", gap:"8px" }}>
        {periods.map(p=>(
          <button key={p.days} onClick={()=>setPeriod(p.days)} style={{ flex:1, padding:"10px", borderRadius:"9px", background:period===p.days?"rgba(0,229,176,.1)":"var(--bg3)", border:`1px solid ${period===p.days?"rgba(0,229,176,.3)":"var(--border)"}`, color:period===p.days?"var(--accent)":"var(--text2)", fontFamily:"var(--font-m)", fontSize:"11px", cursor:"pointer", letterSpacing:"0.08em" }}>
            {p.label}
          </button>
        ))}
      </div>
    ...
    <div style={{ display:"grid", gap:"18px", maxWidth:"640px" }}>
      ...
      {mode==="urge" && (
        <Card cls="fu" style={{ border:"1px solid rgba(230,64,64,.28)", background:"rgba(230,64,64,.04)", animation:"urgePulse 2s infinite" }}>
          ...
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"#f87171", marginBottom:"13px", letterSpacing:"0.12em" }}>ACT NOW — PICK ONE IMMEDIATELY:</div>
          <div style={{ display:"grid", gap:"7px" }}>
            {urgeActions.map((a,i)=>(
              <div key={i} style={{ display:"flex", alignItems:"center", gap:"12px", padding:"12px 14px", borderRadius:"9px", background:"rgba(255,255,255,.02)", border:"1px solid rgba(230,64,64,.13)" }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"2px" }}>{a.sub}</div>
                </div>
              </div>
            ))}
            <button onClick={()=>{resetMode();navigate("training");}} style={{ display:"flex", alignItems:"center", gap:"12px", padding:"12px 14px", borderRadius:"9px", background:"rgba(0,229,176,.05)", border:"1px solid rgba(0,229,176,.15)", cursor:"pointer", textAlign:"left" }}>
              ...
              <div>
                ...
                <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"var(--text3)", marginTop:"2px" }}>Redirect to Training</div>
              </div>
            </button>
          </div>
        </Card>
      ...
      {mode==="override_trigger" && (
        <Card cls="fu" style={{ border:"1px solid rgba(230,64,64,.22)" }}>
          <div style={{ fontFamily:"var(--font-m)", fontSize:"10px", color:"#f87171", letterSpacing:"0.15em", marginBottom:"10px" }}>OVERRIDING TODAY'S SUCCESS ENTRY</div>
      ...
      <Card cls="fu3">
        ...
        {mostCommon && (
          <div style={{ marginTop:"13px", padding:"10px 12px", borderRadius:"9px", background:"rgba(230,160,0,.05)", border:"1px solid rgba(230,160,0,.12)" }}>
            ...
            <div style={{ fontFamily:"var(--font-ui)", fontSize:"12px", color:"var(--text2)", marginTop:"3px" }}>Build targeted defenses around this trigger.</div>
          </div>
        )}
      </Card>
      ...
      <div style={{ minHeight:"100vh", display:"flex", flexDirection:"column" }}>
        <header style={{ height:"56px", display:"flex", alignItems:"center", padding:"0 20px", gap:"14px", borderBottom:"1px solid var(--border)", background:"var(--bg1)", position:"sticky", top:0, zIndex:30 }}>
          <button onClick={()=>setSidebar(o=>!o)}
            style={{ background:"none", border:"1px solid var(--border)", color:"var(--text2)", cursor:"pointer", width:"32px", height:"32px", borderRadius:"7px", fontSize:"14px", display:"flex", alignItems:"center", justifyContent:"center" }}>☰</button>
          {/* Header page label — now text2 for clear readability */}
          <span style={{ fontFamily:"var(--font-m)", fontSize:"11px", color:"var(--text2)", letterSpacing:"0.18em" }}>
            {PAGE_LABELS[page]||""}
          </span>
        </header>
